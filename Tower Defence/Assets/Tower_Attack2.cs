...
public class Tower_Attack2 : MonoBehaviour
{
    [HideInInspector]
    ...
    void Start()
    {
        ...
        bulletPrefab = Resources.Load<GameObject>("bullet2");
    }
    ...
    private void Attack()
    {
        ...
        //add bullet script
        bullets.AddComponent<BulletMove2>().target = targetObject;
        bullets.transform.LookAt(targetObject.transform.position);
        bullets.GetComponent<BulletMove2>().scripts = gameObject.GetComponent<TowerContribute1>();
        bullets.GetComponent<BulletMove2>().scripts1 = targetObject.GetComponent<Enemy>();
        bullets.GetComponent<BulletMove2>().attack1 = this;
    }
}
