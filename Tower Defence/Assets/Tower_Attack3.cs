...
public class Tower_Attack3 : MonoBehaviour
{
    [HideInInspector]
    ...
    void Start()
    {
        ...
        bulletPrefab = Resources.Load<GameObject>("bullet3");
    }
    ...
    private void Attack()
    {
        ...
        //add bullet script
        bullets.AddComponent<BulletMove3>().target = targetObject;
        bullets.transform.LookAt(targetObject.transform.position);

        bullets.GetComponent<BulletMove3>().scripts = gameObject.GetComponent<TowerContribute2>();
        bullets.GetComponent<BulletMove3>().scripts1 = targetObject.GetComponent<Enemy>();
        bullets.GetComponent<BulletMove3>().attack1 = this;
    }
}
