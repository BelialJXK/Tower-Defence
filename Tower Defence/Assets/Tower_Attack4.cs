...
public class Tower_Attack4 : MonoBehaviour
{
    [HideInInspector]
    ...
    void Start()
    {
        ...
        bulletPrefab = Resources.Load<GameObject>("bullet4");
    }
    ...
    private void Attack()
    {
        ...
        //add bullet script
        bullets.AddComponent<BulletMove4>().target = targetObject;
        bullets.transform.LookAt(targetObject.transform.position);

        bullets.GetComponent<BulletMove4>().scripts = gameObject.GetComponent<TowerContribute>();
        bullets.GetComponent<BulletMove4>().scripts1 = targetObject.GetComponent<Enemy>();
        bullets.GetComponent<BulletMove4>().attack1 = this;
    }
}
